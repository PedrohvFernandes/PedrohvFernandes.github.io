...
function pegarIndex(element, functionActive){
...
export function initProject() {
  ...
  if (tabContent.length) {
    ...
    function activeProject(index) {
      ...
      // const direction = tabContent[index].dataset.anime
      tabContent[index].classList.add('active-project', direction(tabContent, index))
    ...
    pegarIndex(tabSection, activeProject)
  }
}
